...
const Product = props => {
    ...
    return (<Card className="card-shadow-hoverable"
        tabIndex={0}
        cover={<img className="cover-img fixed-size" style={{ cursor: 'pointer' }} alt={productDetails.p_code} src={placeholderImg} onClick={() => { history.push(`productDetails?p_code=${productDetails.p_code}`) }}/>}
        actions={[
