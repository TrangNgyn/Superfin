...
export const confirmAddingCategory = (values, form) => {
    Modal.confirm({
        ...
        onOk() {
            return addCategory(values, form);
        }
    })
}

export const confirmDeleteCategory = (value, form) => {
    Modal.confirm({
        ...
        okType: 'danger',
        onOk() {
            return deleteCategory(value.categoryToDelete);
        }
    })
}
